...
[source,bash]
----
jbang-fmt --settings "brace_style=next_line,indentation_size=4" MyFile.java
----
...
**Using @ files with Maven:**

You can also use argument files with the jbang-maven-plugin:
...
**Using @ files with Gradle:**

You can also use argument files with the jbang-gradle-plugin:
...
task format(type: dev.jbang.gradle.JbangTask) {
    script 'jbang-fmt@jbangdev/jbang-fmt'
    args '@formatting-args.txt'
}
----

== TODO

* Add more examples for different formatter styles in Maven/Gradle
