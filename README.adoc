...
* **Advanced configuration:** Override specific formatter settings, line length, and Java version.
...
* `jbang` — JBang's recommended style (default)
...
[source,bash]
----
jbang-fmt --style google --line-length 100 --java 21 MyFile.java
----
