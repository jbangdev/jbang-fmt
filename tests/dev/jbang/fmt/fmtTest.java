...
import dev.jbang.fmt.javafmt.JavaFormatter;
...
public class fmtTest {
	...
	public void testJBangDirectivesSurvive(JavaFormatter formatter) throws Exception {
		...
		assertThat(result).as("Formatter %s should format Java code", formatter.getName()).isNotEqualTo(input)
	...
	public void testFormatterNames(JavaFormatter formatter) throws Exception {
		assertThat(formatter.getName()).as("Formatter should have a non-null name").isNotNull().isIn("Eclipse",
				"Google");
	}
	...
	public void testComplexJavaCode(JavaFormatter formatter) throws Exception {
		...
		assertThat(result).as("Formatter %s should format complex Java code", formatter.getName()).isNotEqualTo(input)
				.contains("public class ComplexTest").contains("private String name")
				.contains("public ComplexTest(String name)").contains("public String getName()")
	...
	public void testNestedStructures(JavaFormatter formatter) throws Exception {
		...
		assertThat(result).as("Formatter %s should handle nested structures", formatter.getName()).isNotEqualTo(input)
				.contains("public class NestedTest").contains("if (true)").contains("if (false)")
				.contains("System.out.println(\"Inner\")").contains("System.out.println(\"Outer\")");
	}
