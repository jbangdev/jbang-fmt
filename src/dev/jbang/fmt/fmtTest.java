...
import dev.jbang.fmt.fmt.JavaFormatter;
...
public class fmtTest {
    ...
    public void testBasicHelloWorld(JavaFormatter formatter) throws Exception {
      ...
      // Verify it's not the same as input (unless input was already formatted)
            assertThat(result.trim())
                .as("Formatter %s should change unformatted code", formatter.getName())
    ...
    public void testEmptyInput(JavaFormatter formatter) throws Exception {
        ...
        assertThatCode(() -> {
            ...
            assertThat(result.trim())
                .as("Formatter %s should handle empty input gracefully", formatter.getName())
    ...
    public void testInvalidJavaCode(JavaFormatter formatter) throws Exception {
        ...
        assertThatCode(() -> {
            ...
            assertThat(result)
                .as("Formatter %s should handle invalid Java code gracefully", formatter.getName())
    ...
    public void testJBangDirectivesSurvive(JavaFormatter formatter) throws Exception {
        ...
        assertThat(result)
            .as("Formatter %s should preserve DEPS directives", formatter.getName())
        ...
        assertThat(result)
            .as("Formatter %s should format Java code", formatter.getName())
            .isNotEqualTo(input)
    ...
    public void testFormatterNames(JavaFormatter formatter) throws Exception {
        assertThat(formatter.getName())
            .as("Formatter should have a non-null name")
            .isNotNull()
            .isIn("Eclipse", "Google");
    }
    ...
    public void testComplexJavaCode(JavaFormatter formatter) throws Exception {
        ...
        assertThat(result)
            .as("Formatter %s should format complex Java code", formatter.getName())
            .isNotEqualTo(input)
    ...
    public void testNestedStructures(JavaFormatter formatter) throws Exception {
        ...
        assertThat(result)
            .as("Formatter %s should handle nested structures", formatter.getName())
            .isNotEqualTo(input)
